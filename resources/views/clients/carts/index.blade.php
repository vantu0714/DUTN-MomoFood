...
<div class="main_content_iner overly_inner ">
    <div class="container-fluid p-0">
        ...
        <div class="container-fluid page-header py-5">
            <h1 class="text-center text-white display-6">Xe đẩy</h1>
            <ol class="breadcrumb justify-content-center mb-0">
                <li class="breadcrumb-item"><a href="#">Trang chủ</a></li>
                <li class="breadcrumb-item"><a href="#">Trang</a></li>
                <li class="breadcrumb-item active text-white">Xe đẩy</li>
            </ol>
        </div>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                <th scope="row">
                                    <div class="d-flex align-items-center">
                                        <img src="{{ asset('clients/img/best-product-4.jpg') }}" class="img-fluid me-5 rounded-circle" style="width: 80px; height: 80px;" alt="">
                                    </div>
                                </th>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p class="mb-0 mt-4">Bông cải xanh tuyệt vời</p>
                                </td>
                                <td>
                                    <p class="mb-0 mt-4">2.99 $</p>
                                </td>
                ...
                <div class="row g-4 justify-content-end">
                    ...
                    <div class="col-sm-8 col-md-7 col-lg-6 col-xl-4">
                        <div class="bg-light rounded">
                            <div class="p-4">
                                <h1 class="display-6 mb-4">Xe đẩy <span class="fw-normal">Tổng cộng</span></h1>
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="">
                                        <p class="mb-0">Tỷ giá cố định: $3.00</p>
                                    </div>
                                </div>
