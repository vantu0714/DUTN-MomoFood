                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="recipient_name" class="form-control" required
                                    value="{{ old('recipient_name', isset($recipient) ? $recipient['recipient_name'] : '') }}">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Số điện thoại</label>
                                <input type="text" name="recipient_phone" class="form-control" required
                                    value="{{ old('recipient_phone', isset($recipient) ? $recipient['recipient_phone'] : '') }}">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Địa chỉ</label>
                                <textarea name="recipient_address" class="form-control" rows="2" required>{{ trim(old('recipient_address', isset($recipient) ? $recipient['recipient_address'] : '')) }}</textarea>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Ghi chú</label>
                                <textarea name="note" class="form-control" rows="2">{{ trim(old('note', isset($recipient) ? $recipient['note'] : '')) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="shipping_fee" class="form-control"
                                    value="{{ old('shipping_fee', 30000) }}" required>
                            </div>
                            ...
                            <a href="{{ route('carts.index') }}">Quay lai</a>
                        </div>
                    </div>
                </div>
            </div>
