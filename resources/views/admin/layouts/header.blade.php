                            ...
                            <div class="header_notification_warp d-flex align-items-center">
                                        ...
                                        <div class="Notification_body">
                                            ...
                                            <div class="single_notify d-flex align-items-center">
                                                <div class="notify_thumb">
                                                    <a href="#"><img
                                                            src="{{ asset('admins/assets/img/staf/2.png') }}" alt></a>
                                                </div>
                                            ...
                                            <div class="single_notify d-flex align-items-center">
                                                <div class="notify_thumb">
                                                    <a href="#"><img
                                                            src="{{ asset('admins/assets/img/staf/4.png') }}" alt></a>
                                                </div>
                                                <div class="notify_content">
                                                    <a href="#">
                                            ...
                                            <div class="single_notify d-flex align-items-center">
                                                <div class="notify_thumb">
                                                    <a href="#"><img
                                                            src="{{ asset('admins/assets/img/staf/3.png') }}" alt></a>
                                                </div>
                                                <div class="notify_content">
                                                    <a href="#">
                                ...
                                <li>
                                    <a class="CHATBOX_open nav-link-notify" href="#"> <img
                                            src="{{ asset('admins/assets/img/icon/msg.svg') }}" alt> </a>
                                </li>
                            </div>
