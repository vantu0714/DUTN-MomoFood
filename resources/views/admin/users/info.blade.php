                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-4">
                                <div class="user-avatar-container">
                                    <img src="{{ Storage::url(Auth::user()->avatar) }}" alt="Avatar của {{ Auth::user()->name }}"
                            ...
                            <div class="col-lg-9 col-md-8">
                                <div class="user-info-section">
                                    <div class="row user-info-row">
                                        ...
                                        <div class="col-md-9 user-info-value">{{ Auth::user()->name }}</div>
                                    </div>
                                    ...
                                    <div class="row user-info-row">
                                        ...
                                        <div class="col-md-9 user-info-value">{{ Auth::user()->email }}</div>
                                    </div>
