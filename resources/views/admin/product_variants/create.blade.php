                    ...
                    <div class="title-section">
                        ...
                        <div>
                            ...
                            <p class="page-subtitle-enhanced" style="font-size: 1.3rem;">
                                Sản phẩm: <strong>{{ $product->product_name }}</strong>
                            </p>
                        </div>
                    </div>
                    <div class="d-flex justify-content-end">
                        <a href="{{ route('admin.product_variants.index') }}" class="btn btn-outline-secondary btn-lg" style="font-size: 1rem;">
                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive" style="max-height: 500px; overflow-y: auto;">
                            <table class="table table-hover mb-0" id="preview-variants-table">
                              ...
                              <tbody  style="font-size: 5rem; font-weight: 100;"></tbody>
                            </table>
                        </div>
                    ...
                    <div class="card-body p-5">
                        <form method="POST" action="{{ route('admin.product_variants.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="variant-item mb-5">
                                    <div class="card border-0 shadow-lg">
                                        <div class="card-header bg-light d-flex justify-content-between align-items-center py-3"
                                            ...
                                            <button type="button" class="btn btn-danger btn-sm remove-variant" style="font-size: 1rem;">
                                        ...
                                        <div class="card-body p-4">
                                            <!-- Main Attribute -->
                                            <div class="mb-4">
                                                <label class="form-label fw-bold text-dark mb-2" style="font-size: 1.2rem;">
                                                    <i class="fas fa-palette me-2"></i>
                                                    Thuộc tính chính (Vị)
                                                </label>
                                                <div class="input-group" style="height: 50px;">
                                                    <span class="input-group-text bg-primary text-white px-3" style="font-size: 1.1rem;">
                                            ...
                                            <div class="sub-attributes-group">
                                                <label class="form-label fw-bold text-dark mb-3" style="font-size: 1.2rem;">
                                                    ...
                                                    <table class="table table-bordered table-hover shadow-sm">
                                                        <thead class="table-primary">
                                                            <tr style="height: 55px;">
                                                                <th class="text-center py-3 fw-bold" style="font-size: 1.1rem;">
                                                        ...
                                                        <tbody class="sub-attributes-table">
                                                            <tr class="sub-attribute-row" style="height: 65px;">
                                                                <td class="py-3">
                                                                    <select name="variants[0][sub_attributes][0][attribute_value_id]"
                                                                ...
                                                                <td class="py-3">
                                                                    <div class="input-group" style="height: 45px;">
                                                                        <input type="number"
                                                                            ...
                                                                            style="padding: 0.75rem; font-size: 1.4rem; font-weight: 500;">
                                                                        <span class="input-group-text fw-bold px-2" style="font-size: 1.4rem;">VND</span>
                                                                    </div>
                                                                </td>
                                                                <td class="py-3">
                                                                    <input type="number"
                                                ...
                                                <div class="mt-3">
                                                    <button type="button" class="btn btn-success btn-sm add-sub-attribute" style="font-size: 1rem;">
                                                        <i class="fas fa-plus me-1"></i> Thêm lựa chọn mới
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="d-flex gap-3 mb-4">
                                <button type="button" class="btn btn-info btn-sm" id="add-variant" style="font-size: 1rem;">
                            ...
                            <div class="d-flex justify-content-end gap-3">
                                <a href="{{ route('admin.product_variants.index') }}" 
                                   class="btn btn-secondary btn-sm px-4 py-2" style="font-size: 1.1rem;">
                                    <i class="fas fa-times me-1"></i> Hủy bỏ
                                </a>
                                <button type="submit" class="btn btn-primary btn-sm px-4 py-2" style="font-size: 1.1rem;">
